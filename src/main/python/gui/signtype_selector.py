...
class SigntypeSpecificationLayoutNEW(QVBoxLayout):
    def __init__(self, **kwargs):
        ...
        self.handstype_2hsymmetryyes_radio = SigntypeRadioButton("H1 and H2 are bilaterally symmetric", parentbutton=self.handstype_2h_radio)
        ...
        self.handstype_2hsymmetryno_radio = SigntypeRadioButton("H1 and H2 are not bilaterally symmetric", parentbutton=self.handstype_2h_radio)
        self.handstype_2hsymmetryno_radio.setProperty('abbreviation.path', "2h.bilaterally asymmetric")
    ...
    def setsigntype(self, signtype):
        ...
        if len(nolongeravailable) > 1:
            print("This sign had sign type options specified that are no longer available and will be removed if you click 'save' (but not 'cancel'). Please make note of the following characteristics:")
...
class SigntypeSelectorDialog(QDialog):
    ...
    def __init__(self, signtype, mainwindow, **kwargs):
        ...
        self.signtype_layout = SigntypeSpecificationLayoutNEW()  # TODO KV delete app_ctx)
