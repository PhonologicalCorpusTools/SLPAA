...
class SigntypeSpecificationLayout(QVBoxLayout):
    def __init__(self, **kwargs):
        ...
        # self.handstype_mvmtmirroredreln_group = SigntypeButtonGroup(prt=self)
        ...
        # self.handstype_mvmtmirroredreln_group.addButton(self.handstype_mirroredall_radio)
        # self.handstype_mvmtmirroredreln_group.addButton(self.handstype_mirroredexcept_radio)
        # self.handstype_mvmtmirroredexcept_group = SigntypeButtonGroup(prt=self)
        # self.handstype_mvmtmirroredexcept_group.setExclusive(False)
        ...
        # self.handstype_mvmtmirroredexcept_group.addButton(self.handstype_2hmvmtexceptloc_check)
        # self.handstype_mvmtmirroredexcept_group.addButton(self.handstype_2hmvmtexceptshape_check)
        # self.handstype_mvmtmirroredexcept_group.addButton(self.handstype_2hmvmtexceptorientn_check)
        # self.buttongroups.append(self.handstype_mvmtmirroredreln_group)
        # self.buttongroups.append(self.handstype_mvmtmirroredexcept_group)
        #
        # # buttons and groups for movement direction relations in 2-handed signs
        # self.handstype_mvmtperceptualshape_group = SigntypeButtonGroup(prt=self)
        ...
        # self.buttongroups.append(self.handstype_mvmtperceptualshape_group)
        #
        # # self.handstype_2hmvmtsamedir_radio = SigntypeRadioButton('Same', parentbutton=self.handstype_2hmvmtbothsame_radio)
        # self.handstype_mvmtdirreln_group = SigntypeButtonGroup(prt=self)
        ...
        # self.handstype_mvmtdirreln_group.addButton(self.handstype_2hmvmtsamedir_radio)
        # self.handstype_mvmtdirreln_group.addButton(self.handstype_2hmvmtdiffdir_radio)
        # self.buttongroups.append(self.handstype_mvmtdirreln_group)
...
# TODO KV delete this class
# class SigntypeSpecificationLayoutOLD(QVBoxLayout):
...
#         # buttons and groups for mirroring relations in 2-handed signs
#         self.handstype_mvmtmirroredreln_group = SigntypeButtonGroup(prt=self)
#         self.handstype_mirroredall_radio = SigntypeRadioButton("Everything is mirrored / in phase",
#                                                                parentbutton=self.handstype_2hmvmtsimult_radio)
#         self.handstype_mirroredall_radio.setProperty('abbreviation.path',
#                                                      '2h.both move.move similarly.simultaneous.all in phase')
#         self.handstype_mirroredall_radio.setProperty('abbreviation.include', False)
#         self.handstype_mirroredexcept_radio = SigntypeRadioButton("Everything is mirrored / in phase except:",
#                                                                   parentbutton=self.handstype_2hmvmtsimult_radio)
#         self.handstype_mirroredexcept_radio.setProperty('abbreviation.path',
#                                                         '2h.both move.move similarly.simultaneous.in phase except')
#         self.handstype_mirroredexcept_radio.setProperty('abbreviation.include', True)
#         self.handstype_mvmtmirroredreln_group.addButton(self.handstype_mirroredall_radio)
#         self.handstype_mvmtmirroredreln_group.addButton(self.handstype_mirroredexcept_radio)
#         self.handstype_mvmtmirroredexcept_group = SigntypeButtonGroup(prt=self)
#         self.handstype_mvmtmirroredexcept_group.setExclusive(False)
#         self.handstype_2hmvmtexceptloc_check = SigntypeCheckBox("Location",
#                                                                 parentbutton=self.handstype_mirroredexcept_radio)
#         self.handstype_2hmvmtexceptloc_check.setProperty('abbreviation.path',
#                                                          '2h.both move.move similarly.simultaneous.in phase except.Loc')
#         self.handstype_2hmvmtexceptloc_check.setProperty('abbreviation.include', True)
#         self.handstype_2hmvmtexceptshape_check = SigntypeCheckBox("Hand configuration",
#                                                                   parentbutton=self.handstype_mirroredexcept_radio)
#         self.handstype_2hmvmtexceptshape_check.setProperty('abbreviation.path',
#                                                            '2h.both move.move similarly.simultaneous.in phase except.HS')
#         self.handstype_2hmvmtexceptshape_check.setProperty('abbreviation.include', True)
#         self.handstype_2hmvmtexceptorientn_check = SigntypeCheckBox("Orientation",
#                                                                     parentbutton=self.handstype_mirroredexcept_radio)
#         self.handstype_2hmvmtexceptorientn_check.setProperty('abbreviation.path',
#                                                              '2h.both move.move similarly.simultaneous.in phase except.Ori')
#         self.handstype_2hmvmtexceptorientn_check.setProperty('abbreviation.include', True)
#         self.handstype_mvmtmirroredexcept_group.addButton(self.handstype_2hmvmtexceptloc_check)
#         self.handstype_mvmtmirroredexcept_group.addButton(self.handstype_2hmvmtexceptshape_check)
#         self.handstype_mvmtmirroredexcept_group.addButton(self.handstype_2hmvmtexceptorientn_check)
...
#
#         # self.handstype_similarmvmt_group = SigntypeButtonGroup(prt=self)
#         self.handstype_2hmvmtbothperceptual_check = SigntypeCheckBox(
#             "Sign includes a non-straight perceptual shape movement", parentbutton=self.handstype_2hmvmtbothsame_radio)
#         self.handstype_2hmvmtbothperceptual_check.setProperty('abbreviation.path',
#                                                               '2h.both move.move similarly.has perceptual shape')
#         self.handstype_2hmvmtbothperceptual_check.setProperty('abbreviation.include', True)
#         self.handstype_mvmtperceptualshape_group.addButton(self.handstype_2hmvmtbothperceptual_check)
#         self.buttongroups.append(self.handstype_mvmtperceptualshape_group)
#
#         # self.handstype_2hmvmtsamedir_radio = SigntypeRadioButton('Same', parentbutton=self.handstype_2hmvmtbothsame_radio)
#         self.handstype_mvmtdirreln_group = SigntypeButtonGroup(prt=self)
#         self.handstype_2hmvmtsamedir_radio = SigntypeRadioButton("Same",
#                                                                  parentbutton=self.handstype_2hmvmtbothperceptual_check)
#         self.handstype_2hmvmtsamedir_radio.setProperty('abbreviation.path',
#                                                        '2h.both move.move similarly.has perceptual shape.same directions')
#         self.handstype_2hmvmtsamedir_radio.setProperty('abbreviation.include', True)
#         self.handstype_2hmvmtdiffdir_radio = SigntypeRadioButton("Different",
#                                                                  parentbutton=self.handstype_2hmvmtbothperceptual_check)
#         self.handstype_2hmvmtdiffdir_radio.setProperty('abbreviation.path',
#                                                        '2h.both move.move similarly.has perceptual shape.different directions')
#         self.handstype_2hmvmtdiffdir_radio.setProperty('abbreviation.include', True)
#         self.handstype_mvmtdirreln_group.addButton(self.handstype_2hmvmtsamedir_radio)
#         self.handstype_mvmtdirreln_group.addButton(self.handstype_2hmvmtdiffdir_radio)
#         self.buttongroups.append(self.handstype_mvmtdirreln_group)
...
#         self.direction_box.setProperty('TEMP-STOPHERE', True)
...
class SigntypeSelectorDialog(QDialog):
    ...
    def __init__(self, signtype, mainwindow, **kwargs):
        super().__init__(**kwargs)
