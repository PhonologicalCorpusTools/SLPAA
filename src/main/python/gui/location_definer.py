...
class LocationDefinerDialog_(QDialog):
...
class LocationDefinerPage(QWidget):
    def __init__(self, image_path=None, locations=dict(), viewer_size=500, **kwargs):
        ...
        self.location_viewer.setFixedSize(viewer_size, viewer_size)
        if image_path:
            self.location_viewer.set_photo(QPixmap(image_path))
...
class LocationDefinerTabWidget(QTabWidget):
    def __init__(self, images, **kwargs):
        ...
        tabbar = EditableTabBar(parent=self)
        tabbar.plus_clicked.connect(self.add_location_tab)
    ...
    def add_location_tab(self, index):
        ...
        new = LocationDefinerPage(parent=self)
