...
Select this if the sign only involved one hand. If the forearm, elbow, or wrist of the H2 is involved, there are several ways this can be coded: (1) the user can decide to specify the sign as one-handed and include H2 in specifications of contact and location, (2) the user can specify the sign as one-handed and select "forearm involved" in the hand configuration module, (3) the user can specify the sign as two-handed, later specifying that "only H1 moves". For example, the sign `CRACKER <https://asl-lex.org/visualization/?sign=cracker>`_ can be coded as (1) one-handed, with H1 making contact to H2 at the elbow, (2) one-handed and select "forearm involved" in the hand configuration module, or (3) two-handed, with only H1 specified as moving. The sign `TABLE <https://asl-lex.org/visualization/?sign=table>`_ can be coded with the same options as above, with the additional possibility to code the contact that H2 makes with the elbow of H1 in a separate location module and contact module.
