...
.. note::
  The following sections on :ref:`Movement Direction Relation<signtype_movement_direction_relation>` and :ref:`Movement Timing Relation<signtype_movement_timing_relation>` should be specified only for signs where H1 and H2 *‘move similarly.’* 
